function Textarea() {
    return (
        <div className="flex flex-col items-center justify-center justify-between mt-12 gap-4 ">
            ...
            <textarea rows="20" cols="50" className="bg-[#14152a] text-[#ffffff] focus:border-white focus:ring-2 focus:ring-indigo-600 focus:outline-none shadow-2xl rounded-lg" placeholder="Enter your Note here"></textarea>
        </div>
    )
}
